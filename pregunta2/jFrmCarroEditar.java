...
public class jFrmCarroEditar extends javax.swing.JFrame {

    public jFrmCarroEditar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFrmCarroEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFrmCarroEditar().setVisible(true);
            }
        });
    }
